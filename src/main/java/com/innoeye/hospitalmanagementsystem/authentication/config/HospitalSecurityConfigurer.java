...
import com.innoeye.hospitalmanagementsystem.authentication.filter.HospitalRequestFilter;
...
public class HospitalSecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		/*http.csrf().and().cors().disable()
            ...
            .and()
            .httpBasic();*/
		/*http.csrf().disable().cors().disable().authorizeRequests().antMatchers("/authenticate").permitAll().anyRequest().authenticated()
